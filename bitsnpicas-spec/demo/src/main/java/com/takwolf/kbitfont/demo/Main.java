...
public class Main {
    ...
    private static void convertKbitsToKbitx(File kbitsFile, File kbitxFile) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        convertKbitsToKbitx(new File(testFontsDir, "Athens.kbits"), new File(testFontsDir, "Athens.kbitx"));
        convertKbitsToKbitx(new File(testFontsDir, "Geneva-12.kbits"), new File(testFontsDir, "Geneva-12.kbitx"));
        convertKbitsToKbitx(new File(testFontsDir, "New-York-14.kbits"), new File(testFontsDir, "New-York-14.kbitx"));
        ...
        font.setKernPair(new GlyphPair(4000, 5000), 1);
        font.setKernPair(new GlyphPair("A", "B"), 2);
        font.setKernPair(new GlyphPair(4001, "C"), 3);
        font.setKernPair(new GlyphPair("D", 5001), 4);
